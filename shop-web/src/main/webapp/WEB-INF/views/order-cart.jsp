...
<!--shortcut end-->
	...
	<div class="w w1 header clearfix">
		<div id="logo"><a href="http://www.shop.com/"><img src="/images/jt-logo.png"  alt="京淘商城" /></a></div>
		...
		<table class="order-table">
			...
			<c:forEach items="${carts }" var="cart">
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://www.shop.com/item/${cart.itemId}.html" target='_blank'><img width="52" height="52" src="${cart.itemImage}"></a></div>
							 <div class="p-detail">
								<div class="p-name">
