...
import com.shop.web.pojo.Cart;
import com.shop.web.pojo.Item;
...
public class CartService{
	...
	//修改数量 http://www.shop.com/service/cart/update/num/562379/3
	...
	//删除商品，http://cart.shop.com/cart/delete/{userId}/{itemId}
	//
	public void deleteCart(Long userId, Long itemId) throws Exception{
		String url = "http://cart.shop.com/cart/delete/"+userId+"/"+itemId;
		httpClientService.doGet(url);
	}
}
