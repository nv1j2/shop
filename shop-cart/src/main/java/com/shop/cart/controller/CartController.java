...
public class CartController {
	...
	//我的购物车 http://cart.shop.com/cart/query/{userId}
	...
	//商品新增，保存商品 http://cart.shop.com/cart/save
	@RequestMapping("/save")
	@ResponseBody
	...
	//商品数量修改，http://cart.shop.com/cart/update/num/{userId}/{itemId}/{num}
	...
	//商品删除，http://cart.shop.com/cart/delete/{userId}/{itemId}
	...
	//某个用户的某个商品是否存在 ，http://cart.shop.com/cart/item/{userId}/{itemId}
